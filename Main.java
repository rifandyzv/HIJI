        ...
        while (!exit) {
            ...
            if (perintah == 1){
                ...
                while(gameOn){
                    int skipTimes = 0;
                    int drawTwoStatus = 0;
                    if (currentCard instanceof DrawFour || currentCard instanceof DrawTwo) {
                        onDraw = true;
                    }
                    while (onDraw) {                        
                        ...
                        if (draw == 1) {
                            ...
                            if (tempCard instanceof DrawFour) {
                                drawAccumulation += 4;
                                System.out.println("");
                            ...
                            else if (tempCard instanceof DrawTwo && tempCard.equals(currentCard)) {
                                drawAccumulation += 2;
                            }
                            else {
                                System.out.println("Kartu bukan kartu DRAW !");
                    ...
                    if (gameCommand == 0){
                        ...
                        if(tempCard.equals(currentCard)){
                            ...
                            for(int i = 0; i < listPlayer.get(currentPlayer).cardsInHand(); i++){
                                if(i != (discardIndex-1)){
                                    if (tempCard.equals(listPlayer.get(currentPlayer).getCard(i))){
                                        multiCardCheck = true;
                                    }
                                }
                            }
